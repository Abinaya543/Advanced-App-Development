...
const EcommerceTable = () => {
  ...
  const [products, setProducts] = useState([
    ...
    { id: 3, name: 'calender', price: 670, photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeiFcJzjw--cERDZoD1C9ZrF9PUTl-PzWkMnI4u9Adw_ylpejB4eEi5ETH07jdROvJfqg&usqp=CAU' },
  ]);
